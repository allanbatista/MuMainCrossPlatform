...
| `inventory-vault-equipment` | `mu_gameplay`, `mu_ui`, `mu_protocol` | item grids/actions/mix | item/vault/trade/player-shop/mix packets | item DTO, slot, serial, extended serialization | inventory/vault/equipment permissions | property tests, fake server | extended item serialization, no retailer/industry split |
...
| `guild-social-events` | `mu_gameplay`, `mu_ui`, `mu_protocol` | party/social/event flows | guild/social/party/quest/event/duel/gens packets | guild ids, party ids, quest ids, event params | server permissions/event state | fake server/e2e tests | Season 6 server behavior, no retailer/industry split |
...
| F5.S1.T4 Item/vault/trade/shop/mix packets | `feature-network` | `port_rust/crates/mu_protocol/src/{items.rs,vault.rs,trade.rs,player_shop.rs,mix.rs}` | F5.S1.T1 | item/vault/trade/player-shop/mix groups covered | property + golden tests |
...
| F5.S1.T6 Guild/social/party/quest/event packets | `feature-network` | `port_rust/crates/mu_protocol/src/{guild.rs,social.rs,party.rs,quests.rs,events.rs}` | F5.S1.T1 | guild/social/party/quest/event groups covered | golden tests |
...
| F8.S2.T1 Items/inventory/equipment/vault/mix | `feature-items` | `port_rust/crates/mu_gameplay/src/{items.rs,inventory.rs,equipment.rs,vault.rs,mix.rs}`, `port_rust/crates/mu_ui/src/inventory.rs` | F5, F6 | move/use/equip/desequip/mix/serialize/sync errors work | property + fake server tests |
...
- Property tests for packet encode/decode, inventory/item moves/mix, helper rules and transaction idempotency.
...
| AC-08 | F5.S1.T4, F8.S2.T1 | Evidencia: property and fake server inventory/vault/equipment/mix tests |
